console.log(localStorage.getItem("index"),"ok");

function fetchProductData() {
  const id = JSON.parse(localStorage.getItem("index")) + 1;  // to track the object
    ...
    .then((data) => {
      ...
      addtocart.addEventListener('click', () => {
        ...
        if (!arr) {
          ...
          arr.push(id);
          const uniqueArr = Array.from(new Set(arr));   // to remove duplicate 
